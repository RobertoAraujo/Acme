package com.lamppit.vitrine.util;
...
public class JwtUtilities {
    ...
    public String extractEmail(String token)
            throws SignatureException, ExpiredJwtException, UnsupportedJwtException,
            MalformedJwtException, IllegalArgumentException, Exception {
        return extractUserLoginDto(token).getUserEntity().getEmail();
    }
